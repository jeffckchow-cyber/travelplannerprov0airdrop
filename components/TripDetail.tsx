...
export const TripDetail: React.FC<TripDetailProps> = ({ onBack }) => {
  ...
  const renderSubTabs = () => (
    <div className="flex justify-around bg-[#1C1C1E] px-1 overflow-x-auto no-scrollbar">
  ...
  // Standardized input height for all fields on iPhone (56px)
  const inputClasses = "h-14 min-h-[56px] w-full bg-[#1C1C1E] rounded-xl px-4 text-base font-bold border border-white/5 outline-none focus:border-[#D4AF37] box-border appearance-none text-white";

  return (
    <div className="flex flex-col h-screen h-[100dvh] bg-[#1C1C1E] text-white overflow-y-auto no-scrollbar scroll-smooth">
      {/* BANNER SECTION - Standard block, scrolls up naturally */}
      ...
      {/* STICKY HEADER SECTION - Combines Nav and Calendar so they dock together */}
            ...
            <div className="space-y-4">
              ...
              <div className="relative min-h-[400px]">
                {isEditingNotes ? (
                  ...
                  <div className="w-full min-h-[400px] bg-[#2C2C2E] border border-white/5 rounded-[24px] p-6 text-white/80 text-base font-medium leading-relaxed whitespace-pre-wrap break-words overflow-wrap-anywhere overflow-hidden shadow-inner">
                ...
                {isModalOpen === 'activity' && (
                  <>
                    ...
                    <div className="space-y-1">
                      ...
                      <input type="time" className={inputClasses} value={newActivity.time} onChange={e => setNewActivity({...newActivity, time: e.target.value})} />
                    </div>

                    <div className="space-y-1">
                      <label className="text-[9px] font-black opacity-30 uppercase ml-2">Destination Name</label>
                      <input type="text" className={inputClasses} placeholder="e.g. Times Square" value={newActivity.location} onChange={e => setNewActivity({...newActivity, location: e.target.value})} />
                    </div>

                    <div className="space-y-1">
                      <label className="text-[9px] font-black opacity-30 uppercase ml-2">Google Maps Link</label>
                      <input type="url" className={inputClasses} placeholder="https://goo.gl/maps/..." value={newActivity.mapLink} onChange={e => setNewActivity({...newActivity, mapLink: e.target.value})} />
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <input type="number" className={inputClasses} placeholder="0" value={newActivity.cost || ''} onChange={e => setNewActivity({...newActivity, cost: Number(e.target.value)})} />
                    </div>
                ...
                {isModalOpen === 'stay' && (
                  <>
                    <div className="space-y-1">
                      ...
                      <input type="text" className={inputClasses} placeholder="e.g. Grand Central Hotel" value={newStay.name} onChange={e => setNewStay({...newStay, name: e.target.value})} />
                    </div>
                    <div className="space-y-1">
                      <label className="text-[9px] font-black opacity-30 uppercase ml-2">Full Address</label>
                      <input type="text" className={inputClasses} placeholder="Street, City, State" value={newStay.location} onChange={e => setNewStay({...newStay, location: e.target.value})} />
                    </div>
                    <div className="space-y-1">
                      <label className="text-[9px] font-black opacity-30 uppercase ml-2">Google Maps Link</label>
                      <input type="url" className={inputClasses} placeholder="https://goo.gl/maps/..." value={newStay.mapLink} onChange={e => setNewStay({...newStay, mapLink: e.target.value})} />
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-1"><label className="text-[8px] font-black opacity-30 uppercase ml-2 mb-1 block">Check-in Date</label><input type="date" className={inputClasses} value={newStay.checkIn} onChange={e => setNewStay({...newStay, checkIn: e.target.value})} /></div>
                      <div className="space-y-1"><label className="text-[8px] font-black opacity-30 uppercase ml-2 mb-1 block">Check-out Date</label><input type="date" className={inputClasses} value={newStay.checkOut} onChange={e => setNewStay({...newStay, checkOut: e.target.value})} /></div>
                    </div>
                ...
                {isModalOpen === 'transport' && (
                  <>
                    ...
                    <div className="space-y-1">
                      ...
                      <input type="text" className={inputClasses} placeholder="e.g. DL123" value={newTransport.flightNo} onChange={e => setNewTransport({...newTransport, flightNo: e.target.value})} />
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-1">
                        <label className="text-[9px] font-black opacity-30 uppercase ml-2">Departure Point</label>
                        <input type="text" className={inputClasses} placeholder="From (e.g. SFO)" value={newTransport.from} onChange={e => setNewTransport({...newTransport, from: e.target.value})} />
                      </div>
                      <div className="space-y-1">
                        <label className="text-[9px] font-black opacity-30 uppercase ml-2">Arrival Point</label>
                        <input type="text" className={inputClasses} placeholder="To (e.g. JFK)" value={newTransport.to} onChange={e => setNewTransport({...newTransport, to: e.target.value})} />
                      </div>
                    </div>
                    ...
                    <div className="space-y-4 pt-2">
                      <div className="space-y-2 p-3 bg-[#1C1C1E] rounded-2xl border border-white/5">
                        ...
                        <div className="flex gap-2">
                          <input type="date" className="h-14 min-h-[56px] flex-1 min-w-0 bg-[#1C1C1E] rounded-xl px-3 text-base font-bold border-none outline-none appearance-none box-border" value={newTransport.departureDate} onChange={e => setNewTransport({...newTransport, departureDate: e.target.value})} />
                          <input type="time" className="h-14 min-h-[56px] w-[100px] bg-[#1C1C1E] rounded-xl px-3 text-base font-bold border-none outline-none appearance-none box-border" value={newTransport.departureTime} onChange={e => setNewTransport({...newTransport, departureTime: e.target.value})} />
                        </div>
                      </div>
                      ...
                      <div className="space-y-2 p-3 bg-[#1C1C1E] rounded-2xl border border-white/5">
                        ...
                        <div className="flex gap-2">
                          <input type="date" className="h-14 min-h-[56px] flex-1 min-w-0 bg-[#1C1C1E] rounded-xl px-3 text-base font-bold border-none outline-none appearance-none box-border" value={newTransport.arrivalDate} onChange={e => setNewTransport({...newTransport, arrivalDate: e.target.value})} />
                          <input type="time" className="h-14 min-h-[56px] w-[100px] bg-[#1C1C1E] rounded-xl px-3 text-base font-bold border-none outline-none appearance-none box-border" value={newTransport.arrivalTime} onChange={e => setNewTransport({...newTransport, arrivalTime: e.target.value})} />
                        </div>
                      </div>
                    </div>
                ...
                {isModalOpen === 'settings' && (
                  <div className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <input type="text" className={inputClasses} value={editTripData.title} onChange={e => setEditTripData({...editTripData, title: e.target.value})} />
                    </div>
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="space-y-1">
                            ...
                            <input type="date" className={inputClasses} value={editTripData.startDate} onChange={e => setEditTripData({...editTripData, startDate: e.target.value})} />
                        </div>
                        <div className="space-y-1">
                            <label className="text-[9px] font-black opacity-30 uppercase ml-3 tracking-[0.2em]">End Date</label>
                            <input type="date" className={inputClasses} value={editTripData.endDate} onChange={e => setEditTripData({...editTripData, endDate: e.target.value})} />
                        </div>
                    </div>
